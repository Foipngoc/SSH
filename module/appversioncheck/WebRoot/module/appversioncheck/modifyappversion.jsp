...
<html>
  ...
  <form id="form" enctype="multipart/form-data" action="module/appversioncheck/updateAppVersion" method="post">
	...
	<h2>版本号&nbsp;&nbsp;<input type="text" name="versioncode" id="versioncode" readonly="readonly" style="border: 0px;"></h2> <br>
	...
	<h2>选择APP&nbsp;&nbsp;<input type="text" id="respath" style="border:0px;" readonly="readonly"><input style="width: 73px;" type="file" name="file" id="file" onchange="filesel()"></h2><br>
